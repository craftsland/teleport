...
func isKnownUncollectedKind(kind string) bool {
	switch kind {
	case types.KindAccessRequest, types.KindHeadlessAuthentication, types.KindUserEncryptionKeys, scopedaccess.KindScopedRole, scopedaccess.KindScopedRoleAssignment, types.KindValidatedMFAChallenge:
		return true
	default:
		return false
	}
