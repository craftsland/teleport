...
For example: a `/test` operator cannot manage resources in the `/test/sub` scope.
...
- Read and Write access to the `/` scope
<Tabs>
<TabItem label="tctl">
...
teleport-operator-75855944c-sskk5   1/1     Running   0          22s
```
