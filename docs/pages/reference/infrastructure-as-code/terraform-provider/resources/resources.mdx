...
The Teleport Terraform provider supports the following resources:
  ...
  - [`teleport_db_object_import_rule`](./db_object_import_rule.mdx)
  ...
  - [`teleport_kube_cluster`](./kube_cluster.mdx)
  - [`teleport_lock`](./lock.mdx)
  ...
  - [`teleport_retrieval_model`](./retrieval_model.mdx)
  ...
  - [`teleport_ui_config`](./ui_config.mdx)
  - [`teleport_user`](./user.mdx)
  - [`teleport_vnet_config`](./vnet_config.mdx)
  - [`teleport_workload_cluster`](./workload_cluster.mdx)
